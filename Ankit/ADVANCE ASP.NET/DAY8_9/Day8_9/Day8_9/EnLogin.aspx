<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EnLogin.aspx.cs" Inherits="Day8_9._Default" %>
...
<body>
    ...
    <asp:TableRow><asp:TableCell>
        <asp:Label ID="lblUser" runat="server" Text="UserID" Width="250px" ></asp:Label>
    </asp:TableCell>
    <asp:TableCell>
    ...
    <asp:TableRow><asp:TableCell>
        ...
        <asp:TextBox ID="txtPass" runat="server" Width="250px" TextMode="Password"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" Text="*" SetFocusOnError="true" runat="server" ControlToValidate="txtPass" ErrorMessage="You must enter Password" Display="None"></asp:RequiredFieldValidator>
    </asp:TableCell></asp:TableRow>
    <asp:TableRow><asp:TableCell>    
                <asp:Button ID="btnSignIn" Text="Submit" runat="server" Width="250px" onclick="btnSignIn_Click"  />     
    </asp:TableCell><asp:TableCell>
