<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditEmployees.aspx.cs" Inherits="Day2_4.EditEmployees" %>
...
<body>
    ...
    <asp:GridView ID="gvEditEmployees" runat="server"  
     ...
     AutoGenerateColumns="False" RowStyle-Wrap="true" BackColor="#DEBA84" 
...
<asp:TemplateField HeaderText="Edit" >
     ...
     <asp:TemplateField HeaderText="EmployeeID" >
            ...
            <asp:TemplateField HeaderText="Notes"  >
                <ItemTemplate>
              <asp:TextBox ID="lblNotes" runat="server" TextMode="MultiLine" Text='<%# bind("Notes")%>' ReadOnly="true" ></asp:TextBox>                    
                </ItemTemplate>
            </asp:TemplateField>            
