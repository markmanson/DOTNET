...
namespace DAY5EXercise
{
	...
	public class EmployeesSchema : NCI.EasyObjects.Schema
	{
		...
		public static SchemaItem EmployeeID = new SchemaItem("EmployeeID", DbType.Int32, true, false, false, true, false, false);
	...
	public abstract class _Employees : EasyObject
	{
		...
		public bool LoadByPrimaryKey(int EmployeeID)
		{
			switch(this.DefaultCommandType)
			{
				case CommandType.StoredProcedure:
					...
					return base.LoadFromSql(this.SchemaStoredProcedureWithSeparator + "daab_EmpGetEmployees", parameters, CommandType.StoredProcedure);
		...
		public bool LoadAll()
		{
			...
			{
				case CommandType.StoredProcedure:
					return base.LoadFromSql(this.SchemaStoredProcedureWithSeparator + "daab_EmpGetAllEmployees", null, CommandType.StoredProcedure);
		...
		{	
			...
			{
				case CommandType.StoredProcedure:
					string sqlCommand = this.SchemaStoredProcedureWithSeparator + "daab_EmpAddEmployees";
		...
		protected override DbCommand GetUpdateCommand(CommandType commandType)
		{
			...
			{
				case CommandType.StoredProcedure:
					string sqlCommand = this.SchemaStoredProcedureWithSeparator + "daab_EmpUpdateEmployees";
					dbCommand = db.GetStoredProcCommand(sqlCommand);
		...
		protected override DbCommand GetDeleteCommand(CommandType commandType)
		{
			...
			{
				case CommandType.StoredProcedure:
					string sqlCommand = this.SchemaStoredProcedureWithSeparator + "daab_EmpDeleteEmployees";
					dbCommand = db.GetStoredProcCommand(sqlCommand);
					db.AddInParameter(dbCommand, "EmployeeID", DbType.Int32, "EmployeeID", DataRowVersion.Current);
