<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmployeeTerritoriesRegister.aspx.cs" Inherits="ExerciseProject.Day5.EmployeeTerritoriesRegister" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
   <title>Insert/Update with validation in EmployeeTerritories</title>
    <style type="text/css">
        .style1
        {
            width: 21%;
    ...
    function SetFocus()
    {
        ValidationForm.TxtEmployeeID.focus();
        return true;
    }
    ...
    <asp:Panel runat="server" ID="Panel1">
        ...
        <tr>
            <td colspan="2" bgcolor="White">
                <asp:Label ID="Label1" runat="server" Text="Employee Form" Font-Bold="True" 
         ...
         <tr bgcolor="White">
            ...
            <td>
                ...
                <asp:Calendar ID="Cal1" runat="server" Height="68px" 
                     Visible="False" Width="29px" onselectionchanged="Cal1_SelectionChanged">
                </asp:Calendar>
         ...
         <tr bgcolor="White">
            ...
            <td>
                ...
                <asp:Calendar ID="Cal2" runat="server" 
                    Visible="False" onselectionchanged="Cal2_SelectionChanged" Width="168px">
                </asp:Calendar>
        ...
        <tr>
            <td colspan="2" bgcolor="White">
                <asp:Label ID="LblNewUser" runat="server" Text="EmployeeTerritories description" Font-Bold="True" 
                    Font-Names="Arial Rounded MT Bold" Font-Size="small" Font-Underline="True" 
                    ForeColor="#0033CC"></asp:Label>
            </td>
        </tr>
        <tr bgcolor="White">
            <td class="style2">
                <asp:Label ID="LblEmployeeID" runat="server"  Font-Bold="False" Font-Names="Franklin Gothic Demi Cond" 
                    Font-Size="Small" ForeColor="#0033CC" Text="Territory Description:"></asp:Label>
            </td>
            <td>
                <asp:ListBox ID="LstListBox" DataTextField="TerritoryDescription" DataValueField="TerritoryDescription"
                    runat="server" Width="95%" SelectionMode="Multiple"></asp:ListBox>
            </td>
        </tr>
         <tr bgcolor="White">
            <td colspan="2">
                <asp:Button ID="btnSubmit" runat="server" Text="Submit" Width="101px" OnClientClick="return validationvalue();" 
