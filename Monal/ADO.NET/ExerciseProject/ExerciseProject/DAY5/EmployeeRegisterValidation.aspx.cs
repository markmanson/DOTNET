...
{
    ///Summary
    /// Name:EmployeeRegisterValidation.aspx
    /// Description:In this page insert and update delete the record of the employees table and also with validation
    /// Author:Monal Shah
    /// Created Date:2010/09/30
    /// summary
    public partial class EmployeeRegisterValidation : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                try
                {
                    ...
                    //objCl.GetSqlStmt = "Select * From Employees";// where EmployeeID='" + intIdValue + "'";
                    //objDTable = new DataTable();
                    //objDTable = objCl.DataTables();
                    //if (intIdValue == objDTable.Rows[0]["EmployeeID"])
                    //{
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (intIdValue == 0)
                {
                    ...
                    {
                        objEmp.ReportsTo = Convert.ToInt32(null);
                    }
