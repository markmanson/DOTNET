<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Emp_Territory1.aspx.cs" Inherits="ADO_Day2_4.Emp_Territory1" %>
...
<body>
    ...
    <div align="center">
        ...
        <asp:GridView ID="gvEmployeeTerritory" runat="server" AllowPaging="True" Width="20%" 
            ...
            onpageindexchanging="gvEmployeeTerritories_PageIndexChanging" CaptionAlign="Top"
