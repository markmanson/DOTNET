<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Employee_Ex6.aspx.cs" Inherits="ADV_ASP_Day5_6.Employee_Ex6" %>
<%@ OutputCache Duration="60" VaryByParam="None" VaryByControl="DdlEmployee" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Employee_Ex6</title>
    <style type="text/css">
    .table
    {       
        border-style:solid;        
