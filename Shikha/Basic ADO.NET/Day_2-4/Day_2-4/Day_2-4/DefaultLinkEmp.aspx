<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DefaultLinkEmp.aspx.cs" Inherits="Day_2_4.DefaultLinkEmp" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>LinkEmpName</title>
    <style type="text/css">
        #form1
        {
            height: 147px;
...
<body>
    ...
    <AlternatingRowStyle BackColor="White"></AlternatingRowStyle>
      <Columns>
            ...
            <ItemTemplate>
                <asp:LinkButton ID="LbtnEmployeeName" runat="server" CommandName="export" OnClick="LbtnEmployeeName_Click" Text='<%# Eval("FirstName") + " " + Eval("LastName") %>'>
