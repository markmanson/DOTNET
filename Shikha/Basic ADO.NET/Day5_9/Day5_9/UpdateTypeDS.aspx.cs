...
namespace Day5_9
{
    ...
    //----------------------------------------------------------------------------------------------------------------------------------------------
    public partial class UpdateTypeDS : System.Web.UI.Page
    {
        Common connObj;
        ...
        public void Show_Data()
        {
            if (Session[Constant.strEmpid] != null)
            {
                ...
                DataSetEmp dsEdit;                                                          //DECLARATION FOR OBJECT OF DATASET
                try
                {
                    dsEdit = new DataSetEmp();                                              //INITIALIZING THE OBJECT OF DATASET               
                   ...
                   if (Session[Constant.strEmpid] != null)                                   //IF SESSION HAS SOME VALUES
                    ...
                    adapDA.Fill(dsEdit.Employees );                                                          //FILLING THE ADAPTOR INTO DATASET
                    ...
                    ddlTitle.SelectedValue = dsEdit.Tables[0].Rows[0]["Title"].ToString();
                    ddlTitleOfCourtesy.SelectedValue = dsEdit.Tables[0].Rows[0]["TitleOfCourtesy"].ToString();
            ...
            else
            {
                ...
                ddlTitle.SelectedValue = null;                                                       //ASSIGN NULL TO TITLE  
                ddlTitleOfCourtesy.SelectedValue = null;                                                    //ASSIGN NULL TO TITLEOFCOURTESY 
         ...
         protected void btnADD_Click(object sender, EventArgs e)
        {
            ...
            if (Session[Constant.strEmpid] == null)
            {
                try
                {
                   ...
                   Cmd = new SqlCommand(strB1.ToString(), connObj.connC);                                //INITIALIZATION OF COMMAND
                    ...
                    Cmd.Parameters.Add("@Title", SqlDbType.NVarChar, 30).Value = ddlTitle.SelectedValue.ToString();
                    Cmd.Parameters.Add("@TitleOfCourtesy", SqlDbType.NVarChar, 25).Value = ddlTitleOfCourtesy.SelectedValue.ToString();
            ...
            else
            {
                ...
                finally
                {
                    ...
                    Cmd = null;
                    strB1 = null;
                    Response.Redirect(Constant.strDefault);
                }
            }
        }
