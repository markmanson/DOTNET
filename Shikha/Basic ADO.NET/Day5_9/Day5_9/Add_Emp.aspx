<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add_Emp.aspx.cs" Inherits="Day5_9.Add_Emp" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajaxToolkit" %>
<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>ADD Employee WEBPAGE</title>
...
<body>
    ...
    <tr>
     <td id="emp" runat="server" >EmployeeID:</td>
...
<asp:ListItem Text="Dr." Value="Dr." Selected="False"></asp:ListItem>
     ...
     <asp:RequiredFieldValidator ID="rfvTitleOfCourtesy" 
                 runat="server" 
                ControlToValidate="ddlTitleOfCourtesy"
               ErrorMessage="TitleOfCourtesy can't be left blank" 
                SetFocusOnError="True">* TitleOfCourtesy can't be left blank
...
<ajaxToolkit:CalendarExtender   runat="server" ID="CalendarExtender1" PopupButtonID="imgCal1" TargetControlID="txtBirthDate"
     ...
     <asp:RequiredFieldValidator ID="rfvtxtBirthDate" 
                 runat="server" 
     ...
     <asp:RequiredFieldValidator ID="rfvtxtHireDate" 
                 runat="server" 
   ...
   <asp:RequiredFieldValidator ID="rfvAddress" 
    ...
    <tr>
     ...
     <asp:RequiredFieldValidator ID="rfvtxtCity" 
                 runat="server" 
     ...
     <asp:RequiredFieldValidator ID="rfvtxtRegion" 
                 runat="server" 
    ...
    <asp:RequiredFieldValidator ID="rfvtxtPostalCode" 
                 runat="server" 
     ...
     <asp:RequiredFieldValidator ID="rfvtxtCountry" 
                 runat="server" 
     ...
     <asp:RequiredFieldValidator ID="rfvtxtHomePhone" 
                 runat="server" 
     ...
     <asp:RequiredFieldValidator ID="rfvtxtExtension" 
                 runat="server" 
     ...
     <td>
       <input id="ResetEmp" type="reset" value="RESET"  />
