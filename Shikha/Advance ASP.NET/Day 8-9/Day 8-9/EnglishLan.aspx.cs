...
namespace Day_8_9
{
    ...
    //      DESCRIPTION     :- CLASS FOR ENGLISH LANGUAGE LOGIN FORM.
    //      CREATED DATE    :- 2012/25/09
    //----------------------------------------------------------------------------------------------------------------------------------------------
    public partial class EnglishLan : System.Web.UI.Page
    {
        #region Page_Load
        // ---------------------------------------------------------------------------------------------------------------------------------------------
        //      NAME            :- Page_Load
        ...
        //      AUTHOR NAME     :- Shikha Malik
        //      DESCRIPTION     :- The METHOD FOR CLICK EVENT OF SUBMIT DATA AND CHECK VALID USER OR NOT.
        //      CREATED DATE    :- 2012/25/09
        //----------------------------------------------------------------------------------------------------------------------------------------------
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                if (ValidateUser(txtLoginID.Text, txtPassword.Text))
                {
                    ...
                    Response.Redirect(Constant.strENGWELCMPGE, false);
                }
        ...
        //      AUTHOR NAME     :- Shikha Malik
        //      DESCRIPTION     :- The METHOD FOR CANCEL CLICK EVENT FOR RESET FORM.
        //      CREATED DATE    :- 2012/25/09
        //----------------------------------------------------------------------------------------------------------------------------------------------
